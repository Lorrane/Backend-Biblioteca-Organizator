-- CRIAÇÃO DAS TABELAS
CREATE TABLE tbl_books(isbn int4, title varchar(255), subtitle varchar(255), author varchar(255) not null, publishing varchar(255), yearPubli date, PRIMARY KEY (isbn));
CREATE TABLE tbl_genrers(id int8 generated by default as identity, name varchar(255) not null, primary key(id));
CREATE TABLE tbl_book_genrers(id int8 generated by default as identity, book_id int4, genrer_id int8, primary key(id));
